...
<!-- Document Title -->
<title>BBP-ACADEMY | ACCUEIL</title>
...
<!-- Header -->
  <header class="header-style-2">
    <div class="container logo-div">
      <div class="logo"> <a href="#"><img class="img-responsive img-fluid" src="images/photo_2021-05-13_12-55-52%20(3).jpg" alt="" style="height: 51px;object-fit: cover"></a> </div>
      <div class="head-info">
        <ul>
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#nav-open-btn" aria-expanded="false">
              <span class="toggle-icon to-bar"></span>
